# AORMS Implementation Roadmap (historical)

> **ARCHIVED (2026-07-10):** Moved from `docs/esti/ROADMAP.md`. Active pointers:
> [ROADMAP.md](../../esti/ROADMAP.md) · [UNIFIED-ARCHITECTURE-V4.md](../../esti/UNIFIED-ARCHITECTURE-V4.md).
>
