> **ARCHIVED (2026-07-10):** The standalone `estimate/` app is **not in this monorepo**.
> Kept for historical reference only. Active cost work: [COST-MANAGEMENT-SYSTEM.md](../../esti/COST-MANAGEMENT-SYSTEM.md).
