...
**Human Centric Works** ships **both** a UX **framework** and a UX **process**.  
...
│                 HCW UX (this index)                      │
├────────────────────────────┬─────────────────────────────┤
│  FRAMEWORK (model)         │  PROCESS (how we run)       │
│  What is true · why        │  What we do · when · who    │
│  HCW-UX-FRAMEWORK.md       │  HCW-UX-PROCESS.md          │
└────────────────────────────┴─────────────────────────────┘
                 │                        │
                 ▼                        ▼
        Kit · Catalog · Laws      Checklists · KPIs · Debt
```
...
| [esti/HCW-UI-UX-PRINCIPLES.md](esti/HCW-UI-UX-PRINCIPLES.md) | Domain overlay | Construction lifecycle & stakeholders |
