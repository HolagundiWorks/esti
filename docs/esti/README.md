...
3. [ACCESS-HIERARCHY](ACCESS-HIERARCHY.md) + [PLANS-AND-TIERS](PLANS-AND-TIERS.md) — role capabilities + usage pricing (storage, AI).
...
| [PLANS-AND-TIERS](PLANS-AND-TIERS.md) | **Usage pricing** — storage + AI; 5 GB included; no Lite/Pro/Enterprise (see [AORMS-PRODUCT-AUTOPILOT-ROADMAP](AORMS-PRODUCT-AUTOPILOT-ROADMAP.md)) |
