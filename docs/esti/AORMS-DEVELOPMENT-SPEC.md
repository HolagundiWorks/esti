...
- **Two AI tiers** — **EOMS** (knowledge bank) for codes & compliance; **ESTI** (internal) answers from firm repositories
...
| **4** | **AORMS-Consultancy** engineering app (live); AEC framework marketplace |
