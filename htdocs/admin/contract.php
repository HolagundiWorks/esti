...
if ($conf->use_javascript_ajax) {
	print ajax_constantonoff('CONTRACT_ALLOW_ONLINESIGN', array(), null, 0, 0, 0, 2, 0, 1, '', '', 'inline-block', 0, $langs->transnoentitiesnoconv("WarningOnlineSignature", ESTI_REPOSITORY_URL));
} else {
