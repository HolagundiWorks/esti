...
firms** (architecture and engineering practices that advise clients), governed by
**EmOI** (Embedded Operational Intelligence). **AORMS-Studio** is the live architecture
app; **AORMS-Consultancy** for engineering consultancies is on the roadmap. This
post is about what **AORMS-Studio** does best for Indian architecture practices.
...
AORMS was built to close those two gaps: **fee recovery** and **revision control**.

## Fee recovery: the invoice that should already exist
...
AORMS speaks the billing language of an Indian practice natively: SAC codes, 18%
GST with the correct CGST/SGST or IGST split derived from the site's state, FY-
sequential invoice numbering, TDS net receivables, and the COA proposal structure
stages were agreed against.

## Revision control: the gate before drawings move
