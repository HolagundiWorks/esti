...
- PDFs circulate on WhatsApp without revision numbers.
- Email "OK noted" is not tied to a sheet list.
- Internal issue happens before client approval is logged.
...
Clients approve in a **scoped portal** branded to the firm. Login is optional for
some workflows; token links work for lighter clients.
...
- **Drawings** tab holds the register and transmittals.
- **Client portal** exposes pending approvals per project.
...
### Do clients resist portals?

Offer portal for approvals; accept email PDF as **input** but log approval in the system.

### What about authority approvals (BBMP, etc.)?

Statutory permits live in project info / compliance library; distinguish **statutory**
from **design client** approvals in your taxonomy.
...
- [Drawing approval workflow](/blog/drawing-approval-workflow)
- [Architecture approval workflow software](/architecture-approval-workflow-software)
- [Architect document approval system](/architect-document-approval-system)
