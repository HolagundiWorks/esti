...
AORMS started from a single conviction: the office should be readable as one
system, and software should do the *watching* so the principal does not have to.
