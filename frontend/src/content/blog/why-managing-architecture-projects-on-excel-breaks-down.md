...
This is not an anti-Excel sermon. It is a map of the **failure points** so you can
decide when to move the spine to purpose-built practice software.

## Where Excel wins (and should stay)

- Ad-hoc fee scenarios during negotiation.
- One-off cash-flow what-if models.
- Import/export interchange with accountants.
- Small templates the office copies once per year.
...
**Symptom:** partners stop looking at the sheet; decisions revert to memory.

## What replaces Excel as the spine

A **project-native cloud workspace** where:

- Drawings, decisions, tasks, proposals, and invoices share one project key.
- Roles control who sees commercial data.
...
1. Keep Excel for models; stop adding new **live** projects to master sheets.
2. Move **drawing register + transmittals** first.
3. Add **proposals and invoices** for active commissions.
4. Retire the master fee sheet when two billing cycles reconcile cleanly in AORMS.
...
Collaboration improves; version and evidence problems remain without structure.

### Cost of switching?

Compare senior hours lost to reconciliation vs cloud workspace usage (storage + optional AI).
