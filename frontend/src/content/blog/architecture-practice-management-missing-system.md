...
|-------|---------------------|
| **CRM** | Who is the client, what enquiries are live? |
| **Project record** | What is the brief, phase, and team for this commission? |
| **Drawings** | What was issued, to whom, at which revision? |
| **Revisions** | What changed, who approved, what fee impact? |
| **Fees** | What did we propose, what did we bill, what is overdue? |
| **Site** | What happened on site, what instructions went out? |
| **Knowledge** | What specs and rates does the office reuse? |

Generic "business management" tools cover pieces. Few cover **all** in one
permission-aware workspace shaped for Indian consultancy (GST, COA fees, portals).

## The cost of the missing spine
...
Yes. AORMS prepares invoices, reconciliation, and filing abstracts; your CA files
returns.

## Related reading

- [Generic PM tools fail architecture firms](/blog/generic-pm-tools-fail-architecture)
- [Software for architecture firms](/software-for-architecture-firms)
- [Architecture office management India](/architecture-office-management-india)
