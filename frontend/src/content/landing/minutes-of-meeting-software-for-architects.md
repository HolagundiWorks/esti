...
A minute of meeting is only useful if it sits next to the work it affects. In AORMS
the Minutes tab is part of every project workspace, alongside phases, tasks,
drawings and decisions. You record the title, the date, the attendees, and what was
actually discussed — the design points, the client instructions, the open queries.

Draft minutes stay office-internal while you tidy them. When they are ready, you
**issue** them — the same deliberate action you use for drawings and transmittals.
Issuing locks the minutes into the project's document register with a date, drawing a
clear line between a rough note and a formal record the office stands behind. Nothing
is edited silently after issue.
...
### What is minutes of meeting software for architects?
...
Only after you issue them. Draft minutes stay office-internal while you tidy them;
issuing publishes a dated, locked record to the client portal where the client reads
...
Create your AORMS account at [/account?mode=create](/account?mode=create) or write to [hi@aorms.in](mailto:hi@aorms.in).
