...
const FEATURES: { icon: typeof Money; title: string; body: string }[] = [
  {
    ...
    body: "Every project with general delivery stages, status and contract value in one register.",
  },
  {
    icon: Money,
  ...
  },
  {
    ...
    body: "Scale-of-charges benchmarking with below-minimum compliance guardrails and stage-wise billing.",
  },
  {
    icon: Document,
  ...
  },
  {
    icon: DocumentTasks,
    title: "Documents",
    body: "Proposals, specification sheets, mood boards, drawing transmittals and site inspection reports — as branded PDFs.",
  },
  {
    icon: ChartLineData,
    title: "Filing abstracts",
    body: "GST (GSTR-1/3B) and TDS abstracts by month, ready for your accountant and 26AS reconciliation.",
  },
  {
    icon: Categories,
    title: "Costing & POs",
    body: "Master DSR rates, BOQ estimation, BBS steel calculator and quantity × rate purchase orders.",
  },
  {
    icon: UserMultiple,
    title: "Team & HR",
    body: "Staff register, site in-charge, leaves and payslips — switch the optional HR module on or off.",
  },
  {
    icon: ImageIcon,
    title: "Custom dashboards",
    body: "Drag-and-drop widgets, a clock + leave widget, and seniority-based access for your whole studio.",
  },
];
...
function PricingTile({
  ...
  return (
    ...
    >
      ...
      <p style={{ margin: "4px 0 16px" }}>{note}</p>
      <ul
        style={{
          listStyle: "none",
          padding: 0,
      ...
      >
        {bullets.map((b) => (
          ...
          >
            <Checkmark size={16} style={{ flexShrink: 0, marginTop: 2 }} />
            <span>{b}</span>
          </li>
        ))}
      </ul>
  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      <Header aria-label="ESTI AORMS">
        <HeaderName prefix="ESTI" href="#top">
          AORMS
        </HeaderName>
        <HeaderGlobalBar>
          <HeaderGlobalAction
        ...
        <section style={{ padding: "0 1rem" }}>
          <Grid style={{ paddingTop: "4rem", paddingBottom: "3rem" }}>
            <Column sm={4} md={8} lg={10}>
              <Tag type="blue" size="sm" style={{ marginBottom: 16 }}>
                Built for Indian architects
              </Tag>
              <h1 style={{ margin: 0 }}>
                Spend more time on design — not writing letters or figuring out
                taxes.
              </h1>
              <p style={{ maxWidth: 640, marginTop: 16 }}>
                An architect's place is at the drawing board, not buried in
                invoices, COA fee maths and GST returns. ESTI runs your office
                effortlessly — projects, fees, billing, drawings and documents
                in one place — so you can get back to designing.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              {demo.isPending && (
                <InlineLoading
                  description="Signing in to the demo workspace…"
                  style={{ marginTop: 12 }}
                />
              )}
              <p style={{ marginTop: 12 }}>
                No credit card required · cancel anytime · your data stays in
                your own instance.
              </p>
            </Column>
          </Grid>
          ...
          <Grid>
            <Column sm={4} md={8} lg={16}>
              <h2 style={{ marginBottom: 4 }}>
                The admin runs itself, so your studio runs on design
              </h2>
              <p style={{ marginBottom: 24 }}>
                Everything an Indian architecture office needs — from enquiry to
          ...
          <Grid>
            ...
            <Column sm={4} md={4} lg={6} style={{ marginBottom: "1rem" }}>
              <PricingTile
                ...
                note={
                  annual
                    ? "Billed annually (₹5,988/year). ₹599/mo if billed monthly."
            ...
            <Column sm={4} md={4} lg={5} style={{ marginBottom: "1rem" }}>
              <PricingTile
                ...
                note={
                  annual
                    ? "Billed annually (₹11,988/year). ₹1,299/mo if billed monthly."
            ...
            <Column sm={4} md={8} lg={16}>
              <div>
                ...
                <p style={{ margin: "8px 0 20px" }}>
                  Open a fully populated demo studio and see how little admin
                  ESTI leaves you.
                </p>
                <div
                  style={{
      ...
      <footer style={{ padding: "2rem 1rem" }}>
        <Grid>
          <Column sm={4} md={4} lg={8}>
            <div>ESTI — AORMS</div>
            <p style={{ maxWidth: 420, marginTop: 4 }}>
              Architectural Office Resource Management System. Developed by
          ...
          <Column sm={4} md={8} lg={16}>
            <p style={{ marginTop: 24 }}>
              © {new Date().getFullYear()} Holagundi Consulting Works · aorms.in
              · All rights reserved.
            </p>
          </Column>
        </Grid>
