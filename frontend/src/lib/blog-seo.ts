...
export function applyBlogListSeo(): void {
  ...
  const description =
    "Notes on the AORMS platform (operational and design frameworks, EmOI) and AORMS-Studio — revisions, approvals, GST, billing, and advisory practice operations for Indian architecture consultancies. Product docs: aorms.in/wiki.";
